            ...
            {activeTab === 'buy' && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 bg-green-600 hover:bg-green-700 disabled:bg-slate-700 disabled:cursor-not-allowed rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
                >
                  {orderLoading && (
                  ...
                  {orderLoading ? 'در حال ثبت سفارش...' : 'ثبت سفارش خرید'}
                </button>
              </div>
            )}
