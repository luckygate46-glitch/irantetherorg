...
async def check_saruman_user():
    ...
    register_response = await client.post("https://cryptotradera.preview.emergentagent.com/api/auth/register", json=register_data)
    ...
    if register_response.status_code == 400:
        ...
        if "قبلاً ثبت شده" in register_data_response.get("detail", ""):
            ...
            for password in common_passwords:
                try:
                    login_response = await client.post("https://cryptotradera.preview.emergentagent.com/api/auth/login", json={
                        "email": "saruman.valar@gmail.com",
                        "password": password
                    })
